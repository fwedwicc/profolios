    ...
    >
      <div className='lg:px-24 md:px-16 pt-36'>
        ...
        <div className='gap-3.5 flex flex-wrap'>
          <motion.button
            className={`flex justify-center md:text-sm text-xs items-center gap-2 px-4 py-2 rounded-md ${activeTab === 'allItems' ? 'text-stone-800 bg-stone-200 font-semibold' : 'text-stone-300 bg-transparent hover:bg-stone-800/40 transition duration-300 ease-in-out'
              }`}
          ...
          <motion.button
            className={`flex justify-center md:text-sm text-xs items-center gap-2 px-4 py-2 rounded-md ${activeTab === 'premiumItems' ? 'text-stone-800 bg-stone-200 font-semibold' : 'text-stone-300 bg-transparent hover:bg-stone-800/40 transition duration-300 ease-in-out'
              }`}
          ...
          <motion.button
            className={`flex justify-center md:text-sm text-xs items-center gap-2 px-4 py-2 rounded-md ${activeTab === 'standardItems' ? 'text-stone-800 bg-stone-200 font-semibold' : 'text-stone-300 bg-transparent hover:bg-stone-800/40 transition duration-300 ease-in-out'
              }`}
          ...
          <motion.button
            className={`flex justify-center md:text-sm text-xs items-center gap-2 px-4 py-2 rounded-md ${activeTab === 'basicItems' ? 'text-stone-800 bg-stone-200 font-semibold' : 'text-stone-300 bg-transparent hover:bg-stone-800/40 transition duration-300 ease-in-out'
              }`}
